...
import net.minecraftforge.commonmodelformat.B3D.B3DChestBlock;
import net.minecraftforge.commonmodelformat.B3D.B3DChestTileEntity;
import net.minecraftforge.commonmodelformat.ogex.*;
...
public abstract class CommonProxy
{
    private void registerAnimBlock(Block block, Class<? extends TileEntity> te)
    {
        ...
        GameRegistry.registerTileEntity(te, CommonModelFormatExamples.MODID + ":" + "tile_" + block.getRegistryName().getResourcePath());
    }
